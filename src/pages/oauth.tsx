  ...
  return (
    <div className="p-8">
      ...
      <div className="mt-6 flex gap-4">
        <button className="bg-blue-600 text-white px-4 py-2 rounded">Авторизуватись через LinkedIn</button>
        <button className="bg-blue-800 text-white px-4 py-2 rounded">Авторизуватись через Facebook</button>
      </div>
    </div>
  );
}
